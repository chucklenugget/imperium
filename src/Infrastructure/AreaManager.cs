namespace Oxide.Plugins
{
  ...
  public partial class Imperium
  {
    class AreaManager : ImperiumComponent
    {
      ...
      public AreaManager(Imperium core)
        : base(core)
      {
      ...
      public Area SelectNewHeadquartersIfNecessary(string factionId)
      {
        ...
        Area headquarters = areas.Where(a => a.Type == AreaType.Claimed)
          .OrderByDescending(a => GetDepthInsideFriendlyTerritory(a))
          .First();

        headquarters.Type = AreaType.Headquarters;
        Core.OnAreasChanged();
