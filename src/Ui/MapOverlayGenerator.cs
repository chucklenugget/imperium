namespace Oxide.Plugins
{
  ...
  public partial class Imperium
  {
    class MapOverlayGenerator : UnityEngine.MonoBehaviour
    {
      ...
      public void Init(Imperium core)
      {
        Core = core;
      }
      ...
      {
        IsGenerating = true;
        Core.Puts("Generating new map overlay image...");
        ...
        using (var graphics = Graphics.FromImage(bitmap))
        {
          ...
          Image image = Core.Ui.RegisterImage(UiMapOverlayImageUrl, imageData, true);

          Core.Puts($"Created new map overlay image {image.Id}.");
          IsGenerating = false;
        }
      }
    }
