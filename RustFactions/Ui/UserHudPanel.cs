namespace Oxide.Plugins
{
  ...
  public partial class RustFactions
  {
    ...
    class UserHudPanel
    {
      ...
      public UserHudPanel(RustFactions core, User user)
      {
        Core = core;
        User = user;
      }
      ...
      CuiElementContainer Build()
      {
        ...
        string activePlayers = String.Format("{0:000}", BasePlayer.activePlayerList.Count);
        AddWidget(container, UiElement.HudPanelBottom, UiHudIcon.Players, UserHudPanelColor.TextNormal, activePlayers, 0.33f);

        string sleepingPlayers = String.Format("{0:000}", BasePlayer.sleepingPlayerList.Count);
